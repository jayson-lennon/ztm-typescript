...
console.log("a after translate method", a);
assert.deepEqual([a.x, a.y], [0, 0]);

class Point_bis {
  x: number;
  y: number;
  // z: number; will be created with public keyword

  // We can also write in the constructor, function parameters with the public keyword,
  // this will instatntiate a new property, z in this case.
  constructor(x: number, y: number, public z: number) {
    this.x = x;
    this.y = y;
    //this.z = z; will be instantiated through public keyword in constructor
  }
...
const b = new Point_bis(1, 1, 7);
console.log("b", b);
assert.deepEqual([b.x, b.y, b.z], [1, 1, 7]);
